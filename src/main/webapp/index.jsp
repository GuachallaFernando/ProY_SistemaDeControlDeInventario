    ...
    <div class="form-container">
       ...
       <form action="LogiServlet" method="post">
            <div class="group-material-login">
              <input type="text" id="usuario" name="usuario" class="material-login-control" required="" maxlength="70">
              <span class="highlight-login"></span>
              <span class="bar-login"></span>
              <label><i class="zmdi zmdi-account"></i> &nbsp; Nombres</label>
            </div><br>
            <div class="group-material-login">
              <input type="password" id="passwrd" name="passwrd" class="material-login-control" required="" maxlength="70">
              <span class="highlight-login"></span>
              <span class="bar-login"></span>
