    ...
    <div class="content-page-container full-reset custom-scroll-containers">
        ...
        <section class="full-reset text-center" style="padding: 40px 0;">
            <article class="tile">
                ...
                <div class="tile-num full-reset">2077</div>
            </article>
            <article class="tile">
            ...
            <article class="tile">
                <div class="tile-icon full-reset"><i class="zmdi zmdi-accounts"></i></div>
                <div class="tile-name all-tittles">LOOLES</div>
                <div class="tile-num full-reset">00</div>
            </article>
            <article class="tile">
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-xs-12 col-sm-6">
                        ...
                        <ul class="list-unstyled">
                            <li><i class="zmdi zmdi-check zmdi-hc-fw"></i>&nbsp; Abel Fernando Guachalla Fernandez </li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="footer-copyright full-reset all-tittles">© 2023 Tecnologias Emergentes II</div>
        </footer>
    </div>
</body>
</html>